    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <form method="post" action="{{ route('post.store')}}" enctype="multipart/form-data">
            ...
            <div class="w-60 flex flex-col">
                <label for="images" class="font-semibold mt-4">画像（最大3枚）</label>
                <x-input-error :messages="$errors->get('images')" class="mt-2" />
                <x-input-error :messages="$errors->get('images.*')" class="mt-2" />
                <input type="file" name="images[]" id="images" multiple accept="image/*" class="w-auto p-2 border border-gray-300 rounded-md">
                <p class="text-sm text-gray-500 mt-1">JPEG/PNGなど。1枚あたり5MBまで</p>
            </div>
            <div class="w-full flex flex-col">
